...
$key_update = base64_encode("member_update");

if (!isset($_GET['id'])) {
  echo "<script>window.location.href = 'dashboard';</script>";
}

$id_member = base64_decode(htmlspecialchars(strip_tags($_GET['id'])));
$q_member = mysqli_query($conn, "SELECT A.id_member, A.foto, A.id_member, A.aktif, A.nama as nama_member, A.keterangan, A.created_at, C.nama FROM member A  INNER JOIN users C ON C.id = A.id_user WHERE A.id_member = '$id_member' ORDER BY A.id_member DESC");
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" id="myForm" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="foto_old" id="foto_old" value="<?= $member['foto']; ?>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama" value="<?= $member['nama_member']; ?>">
                  </div>

                  <div class="form-group">
                    <label>Jabatan</label>
                    <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Masukkan Keterangan" value="<?= $member['keterangan']; ?>">
                  </div>
