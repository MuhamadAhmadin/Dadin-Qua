...
$key_add = base64_encode("submenu_add");
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Sub Menu</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="myForm" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="submenu" id="submenu" placeholder="Masukkan Nama submenu">
                  </div>
                  ...
                  <div id="isi_tipe">
                    <div class="form-group" id="custom_link">
                      ...
                      <input type="text" class="form-control" name="link_submenu" id="link_submenu" placeholder="Masukkan link">
                    </div>
                  ...
                  <div class="form-group">
                    <label>Urutan</label>
                    <input type="number" class="form-control" name="urutan_submenu" id="urutan_submenu" min="0" max="10">
                  </div>
