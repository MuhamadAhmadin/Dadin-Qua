...
$key_update = base64_encode("users_update");

if (!isset($_GET['id'])) {
  echo "<script>window.location.href = 'dashboard';</script>";
}

$id_users = base64_decode(htmlspecialchars(strip_tags($_GET['id'])));
$q_users = mysqli_query($conn, "SELECT * FROM users WHERE id = '$id_users'");
$users = mysqli_fetch_assoc($q_users);
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" id="myForm" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="foto_old" id="foto_old" value="<?= $users['foto']; ?>">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Nama</label>
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama" value="<?= $users['nama'] ?>">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
