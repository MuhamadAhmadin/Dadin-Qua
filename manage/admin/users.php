...
$q_pengguna = mysqli_query($conn, "SELECT * FROM users ORDER BY id DESC");
$key_hapus = base64_encode("users_hapus");
$key_reset = base64_encode("users_reset");
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
        	<div class="col-sm-12 text-right">
        		<a href="users/add" class="btn bg-indigo btn-lg"><i class="fas fa-plus"></i></a>
        	</div>
        </div>
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" style="font-size: 14px;">
                  ...
                  <tbody>
                  <?php while($row = mysqli_fetch_assoc($q_pengguna)): ?>
                  <tr>
                    <td>
                      <?php 
                      $foto = $row['foto'];
                    ...
                    <td>
                      <?php 
                      echo get_level($row['level']);
                       ?>
                    </td>

                    <td>
                    	<a href="users/edit/<?= base64_encode($row['id']); ?>/" class="btn btn-sm btn-warning mt-2"><i class="fas fa-edit "></i></a>
                    	<a href="#" id="<?= $row['id']; ?>" class="btn btn-sm btn-danger btn_hapus mt-2"><i class="fas fa-trash"></i></a>
                      <a href="#" id="<?= $row['id']; ?>" class="btn btn-sm btn-primary btn_reset mt-2"><i class="fas fa-key"></i></a>
                    </td>
                  </tr>
              	<?php endwhile; ?>
                </table>
