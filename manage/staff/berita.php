...
$q_berita = mysqli_query($conn, "SELECT A.id_berita, A.status, A.judul, A.gambar, A.created_at, B.kategori, C.nama FROM berita A INNER JOIN kategori B ON B.id_kategori = A.id_kategori INNER JOIN users C ON C.id = A.id_user ORDER BY id_berita DESC");
$key_hapus = base64_encode("berita_hapus");
 ?>
<!DOCTYPE html>
<!--
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
        	<div class="col-sm-12 text-right">
        		<a href="berita/add" class="btn bg-indigo btn-lg"><i class="fas fa-plus"></i></a>
        	</div>
        </div>
      </div><!-- /.container-fluid -->
    </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" style="font-size: 14px;">
                  ...
                  <tr>
                    ...
                    <td>
                    	<a href="berita/edit/<?= base64_encode($row['id_berita']); ?>/" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                    	<a href="#" id="<?= $row['id_berita']; ?>" class="btn btn-sm btn-danger btn_hapus mt-2"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
              	<?php endwhile; ?>
                </table>
